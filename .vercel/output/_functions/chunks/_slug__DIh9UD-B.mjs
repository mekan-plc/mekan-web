import { c as createComponent } from './astro-component_hSSnu1I5.mjs';
import 'piccolore';
import { l as createRenderInstruction, r as renderTemplate, m as maybeRenderHead, h as addAttribute, n as renderComponent, o as renderSlot, p as renderHead, u as unescapeHTML } from './entrypoint_CKUbcb7N.mjs';
import 'clsx';
...
const CACHE_TTL_MS = Number(Object.assign(__vite_import_meta_env__, { WP_API_BASE: "http://localhost:8881/wp-json/wp/v2", _: "C:/Program Files/nodejs/node.exe" })?.WP_CACHE_TTL_SECONDS || "60") * 1e3;
